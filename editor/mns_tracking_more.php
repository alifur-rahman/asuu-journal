									...
									<div class="col-12">
										<div class="list_wrapper">
											...
											<div class="other_info my-1">
												<ul class="list-group list-group-horizontal flex-wrap">
													<li class="list-group-item">Submission Date:
														<?php echo $row['date_s']; ?>
													</li>
													<li class="list-group-item">Journal Type:
														<?php echo $row['category']; ?>
													</li>
													<li class="list-group-item border-0">Publisher: ASUU</li>
													<li class="list-group-item border-0">Status:
														<?php echo $row['status']; ?>
													</li>
												</ul>
											</div>
											...
											<div class="pdf_section">
												<div class="abstract_wrap" data-toggle="modal" data-target="#myModal"
													type="button">
			...
			<div class="modal-dialog modal-xl">
				<div class="modal-content">
					...
					<div class="modal-body">
						<iframe src="Abstract.pdf" style="width:100%; height:600px;" frameborder="0"></iframe>
					</div>
