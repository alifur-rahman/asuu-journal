							...
							<div>
								<form action="" method="POST" enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<input class="form-control" type="text" id="m_name" name="onames"
													placeholder="Middle Name" value="<?php echo $m_name; ?>" required>
											</div>
										</div>
										<!-- <div class="col-md-6">
								<div class="form-group">
										...
										<div class="col-md-6">
											<div class="form-group">
												<input class="form-control" type="text" id="mobile" name="mobile"
													placeholder="Mobile Number" value="<?php echo $dbmobile; ?>"
													required>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<input class="form-control" type="text" id="institute" name="institute"
													placeholder="institute" value="<?php echo $institute; ?>" required>
											</div>
										</div>
									...
									<input class="form-control" type="text" id="displine" name="displine" placeholder="displine"  value="<?php echo $displine; ?>" required>
										...
										<div class="col-md-6">
											<div class="form-group">
												<input class="form-control" type="email" id="email" placeholder="Email"
													name="email" readonly value="<?php echo $_SESSION['username']; ?>"
													required>
											</div>
										</div>
										...
										<div class="col-md-6 mt-5">
											<div class="form-group text-center mb-3">
												<input name="submit" class="btn btn-outline-primary btn-lg btn-block"
