							...
							<div>
								<form action="#" method="POST">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<input class="form-control" type="text" id="institution"
													name="institution" placeholder="Type Institution"
													value="<?php if (isset($institution)) {
														echo $institution;
													} ?>">
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<input class="form-control" type="text" id="displine" name="displine"
													placeholder="Type displine"
													value="<?php if (isset($displine)) {
														echo $displine;
													} ?>">
											</div>
										</div>
