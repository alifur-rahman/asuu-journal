...
<body>
	<div class="login-wrap customscroll d-flex align-items-center flex-wrap justify-content-center pd-20">
		<div class="login-box bg-white box-shadow pd-30 border-radius-5">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="input-group">
							<input class="btn btn-outline-primary btn-lg btn-block" type="submit" name="login"
								value="Sign In">
			...
			<h7><a style="color:#ED2F59; margin-left: -80px;" href="reg.php">Register |</a> <a
					style="color:#ED2F59; margin-right: -10px;" href="reset-password.php">Reset Password</a> </h7>
		</div>
