					...
					<xpl-search-bar-migr _ngcontent-nqw-c5="" _nghost-nqw-c11="">
						<div _ngcontent-nqw-c11="" class="search-bar">
							...
							<form _ngcontent-nqw-c11="" class="search-bar-wrapper ng-untouched ng-pristine ng-valid"
								novalidate="" method="POST" action="search-result.php">
								<br />
								<div _ngcontent-nqw-c11="" class="drop-down">
									<label _ngcontent-nqw-c11="">
										<select _ngcontent-nqw-c11="" class="custom-select"
											aria-label="content type dropdown" name="type"><!---->
											<option _ngcontent-nqw-c11="" value="all">All</option>

											<option _ngcontent-nqw-c11="" value="Journal of Humanities">Journal of
												Humanities</option>

											<option _ngcontent-nqw-c11="" value="Journal Social Sciences">Journal Of
												Social Sciences</option>

											<option _ngcontent-nqw-c11="" value="Journal of Science">Journal of Science
											</option>
										...
										<div _ngcontent-nqw-c11="" class="global-search-bar">
											<xpl-typeahead-migr _ngcontent-nqw-c11="" minchars="3" name="search-term"
												...
												<div _ngcontent-nqw-c20="" class="Typeahead">
													...
													<input _ngcontent-nqw-c20="" name="keyword"
														aria-label="Enter search text" autocomplete="off"
														class="Typeahead-input ng-pristine ng-valid ng-touched form-control input_border"
								...
								<div _ngcontent-nqw-c11="" class="search-icon">
									<button _ngcontent-nqw-c11="" class="fa fa-search form-control" aria-label="Search"
										class="fa fa-search" type="submit" name="submit"></button>
								</div>
							</form>
				...
				<div class="row justify-content-center">
					<div class="col-lg-3 col-md-6 bg_color_1 mb-lg-0 mb-4">
						...
						<div class="article_quick_links">
							<ul class="list-group">
								<li class="list-group-item" style="font-weight: 700; color: #8cc63f">List of Journals &
									Magazines</li>
								<li class="list-group-item">
									<a id="al_tab1" href="#">Journal of Humanities
										<span class="pull-right badge">
											<?php echo postCount($type1); ?>
									...
									<ul class="ALDropdown_menu" id="alDm1">
										...
										foreach ($unick as $row):
											...
											<li>
												<a
													href="journal-view.php?type=1&volume=<?php echo $row['volume']; ?>&vy=<?php echo $row['vy']; ?>">Volume:
													<?php echo $row['volume']; ?> (
													<?php echo $row['vy']; ?>)
												</a>
											</li>
								...
								<li class="list-group-item">
									...
									<ul class="ALDropdown_menu" id="alDm2">
										...
										foreach ($unick as $row):
											...
											<li>
												<a
													href="journal-view.php?type=2&volume=<?php echo $row['volume']; ?>&vy=<?php echo $row['vy']; ?>">Volume:
													<?php echo $row['volume']; ?> (
													<?php echo $row['vy']; ?>)
												</a>
											</li>
								...
								<li class="list-group-item">
									...
									<ul class="ALDropdown_menu" id="alDm3">
										...
										foreach ($unick as $row):
											...
											<li>
												<a
													href="journal-view.php?type=3&volume=<?php echo $row['volume']; ?>&vy=<?php echo $row['vy']; ?>">Volume:
													<?php echo $row['volume']; ?> (
													<?php echo $row['vy']; ?>)
												</a>
											</li>
								...
								<li class="list-group-item">
									...
									<ul class="ALDropdown_menu" id="alDm4">
										...
										foreach ($unick as $row):
											...
											<li>
												<a
													href="journal-view.php?type=4&volume=<?php echo $row['volume']; ?>&vy=<?php echo $row['vy']; ?>">Volume:
													<?php echo $row['volume']; ?> (
													<?php echo $row['vy']; ?>)
												</a>
											</li>
							...
							<div class="row">
								<div class="col-md-4  ">
									<div class="card journel_card text-center">
										<a href="archives.php?type=3"> <img class="card-img-top mx-auto img-fluid"
												src="img/journal_science.png" alt="Card image"></a>
										<div class="card-body">

											<a href="journal_science_board.php">Editorial Board</a> <br>
											<a href="docs/Submission Guidelines.pdf"
												download="Submission Guideline"><img src="img/pdf_icon.png">Submission
												Guidelines</a>
								...
								<div class="col-md-4  ">
									<div class="card journel_card text-center">
										<a href="archives.php?type=1"><img class="card-img-top mx-auto img-fluid"
												src="img/journal_humanities.png" alt="Card image"></a>
										<div class="card-body">
								...
								<div class="col-md-4  ">
									<div class="card journel_card text-center">
										<a href="archives.php?type=2"> <img class="card-img-top mx-auto img-fluid"
												src="img/journal_social.png" alt="Card image"> </a>
										<div class="card-body">
